...
namespace IIS.Sektor
{
    ...
    public class Рекомендац : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Sektor.ПричинУвольн fПричинУвольн;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Sektor.ПричинУвольн.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПричинУвольн"})]
        public virtual IIS.Sektor.ПричинУвольн ПричинУвольн
        {
            get
            {
                ...
                IIS.Sektor.ПричинУвольн result = this.fПричинУвольн;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РекомендацE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РекомендацE", typeof(IIS.Sektor.Рекомендац));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРекомендац : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Sektor.DetailArrayOfРекомендац members)

        // *** End programmer edit section *** (IIS.Sektor.DetailArrayOfРекомендац members)
        ...
        /// </summary>
        public DetailArrayOfРекомендац(IIS.Sektor.ПричинУвольн fПричинУвольн) : 
                base(typeof(Рекомендац), ((ICSSoft.STORMNET.DataObject)(fПричинУвольн)))
        {
        }
        
        public IIS.Sektor.Рекомендац this[int index]
        {
            get
            {
                return ((IIS.Sektor.Рекомендац)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Sektor.Рекомендац dataobject)
        {
