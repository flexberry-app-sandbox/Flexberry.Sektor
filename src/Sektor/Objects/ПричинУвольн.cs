...
namespace IIS.Sektor
{
    ...
    [View("ПричинУвольнE", new string[] {
            ...
            "Специалист.ФИО as \'ФИО\'",
            "ПричУвольн as \'Причина увольнения\'"})]
    ...
    public class ПричинУвольн : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Sektor.DetailArrayOfРекомендац fРекомендации;
        ...
        public virtual IIS.Sektor.DetailArrayOfРекомендац Рекомендации
        {
            get
            {
                ...
                {
                    this.fРекомендации = new IIS.Sektor.DetailArrayOfРекомендац(this);
                }
                IIS.Sektor.DetailArrayOfРекомендац result = this.fРекомендации;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПричинУвольнE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинУвольнE", typeof(IIS.Sektor.ПричинУвольн));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПричинУвольнL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинУвольнL", typeof(IIS.Sektor.ПричинУвольн));
                }
            }
        }
    }
